		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Action: func(context *cli.Context, s string) error {
					...
					default:
						return fmt.Errorf("unsupported AEAD cipher suite: %s", s)
					}
					return nil
				},
			},
			&cli.BoolFlag{
				...
				Usage: "disable encryption for 1-RTT for client",
				Value: false,
				Action: func(context *cli.Context, b bool) error {
					quic.DisableEncryptionQUIC(true)
					return nil
				},
			},
			...
			&cli.BoolFlag{
				...
				Value: false,
				Action: func(context *cli.Context, b bool) error {
					aes.DisableSupportsAES(false)
					qtls.HasAESGCMSP(false)
					return nil
				},
			},
		},
	...
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{
				...
				Usage: "disable encryption for 1-RTT for server",
				Value: false,
				Action: func(context *cli.Context, b bool) error {
					quic.DisableEncryptionQUIC(true)
					return nil
